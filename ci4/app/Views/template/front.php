      ...
      <div class="container">
            ...
            <div class="row">
              <div class="col-md ftco-animate">
                <div class="ftco-footer-widget mb-4">
                  <h2 class="ftco-heading-2">Taste Restaurant</h2>
                  <ul class="list-unstyled">
                    <li><a href="<?= base_url() ?>" class="py-2 d-block">Home</a></li>
                    <li><a href="<?= base_url("#section-menu") ?>" class="py-2 d-block">Menu</a></li>
                    <li><a href="<?= base_url("#section-about") ?>" class="py-2 d-block">About</a></li>
                    <li><a href="<?= base_url("history") ?>" class="py-2 d-block">History</a></li>
                  </ul>
                </div>
              </div>        
            </div>
        ...
        <div class="row ftco-animate">
          <div class="col-md text-left">
            <p>&copy; Taste 2018. Ilham Berlian O.</p>
          </div>
        </div>
      </div>
    </footer>
